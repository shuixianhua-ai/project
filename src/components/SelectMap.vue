...
const dataList=[
  ...
  },
  {
    ...
    description:"OpenStreetMap (OSM for short, open map in Chinese) is an online map collaboration plan. The goal is to create a world map with free content and can be edited by everyone. OSM is a free, open source and editable map service jointly created by the Internet public. OpenStreetMap uses the collective strength and free contribution of the public to improve the geographic data related to the map. OSM is non-profit. It feeds back data to the community and reuse it for other products and services. Other maps sell most of the map data to third parties.",
  },
  {
    name:"LUCC",
    ...
    description:"The new GLC_FCS30-2020 products were produced based on Global 30-m land-cover product with fine classification system in 2015 (GLC_FCS30-2015) and  combined with the 2019-2020 time series Landsat surface reflectance data, Sentinel-1 SAR data, DEM terrain elevation data, global thematic auxiliary dataset and prior knowledge dataset. ",
  },
